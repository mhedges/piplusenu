...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef piplusenu_ana_TStepPointMCAnaModule_hh
#define piplusenu_ana_TStepPointMCAnaModule_hh
...
#include "piplusenu/ana/HistBase_t.h"
#include "piplusenu/ana/SimPar_t.hh"
#include "piplusenu/ana/VDetData_t.hh"

#include "piplusenu/ana/AnaDefs.hh"
...
//-----------------------------------------------------------------------------
  ...
  struct SimpData_t {
    ...
    double        fWeight;
    TSimParticle* fPart[5];             // TSimParticle* parent in the beginning of each stage
  };
